...
>
> **文档规模**：386 篇文档（教程 50 + 附录 76 + 项目 248 + 前沿 11）。2026-08-17 全部 15 个项目完成进阶深化（每项目 +3~18 篇：领域进阶迭代 + ADR 决策资产 + 工业前沿校准）。2026-08-15 完成全量学习路线排序与进阶补充；2026-08-16 新增附录 17-Kafka（10 篇）、18-Observation（8 篇）、19-Agent沙箱（1 篇）、12-评估生态（+3 篇）、11/16/03 扩充各 1 篇、教程 48-多模态、49-支付、前沿 10-边缘Agent，并启动教程 48 篇全量修复+深化（见 PLAN.md）。
...
│   └── 16-企业级Agent服务网格/            # Mesh 视角（11 篇：透明拦截/xDS/身份/治理/遥测/联邦）
│
...
| [15-企业级Agent操作系统内核](项目/15-企业级Agent操作系统内核/00-需求分析与架构设计.md) | **内核视角旗舰** | OS 隐喻：进程/syscall/记忆FS/调度cgroup/信号HITL/IPC-ns + ADR | 11 |
| [16-企业级Agent服务网格](项目/16-企业级Agent服务网格/00-需求分析与架构设计.md) | **网格视角旗舰** | 零改造 Sidecar/xDS/身份mTLS/流量治理+混沌+Kill/自动遥测/联邦 + ADR | 11 |
