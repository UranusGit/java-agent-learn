...
>
> **文档规模**：417 篇文档（教程 50 + 附录 76 + 项目 279 + 前沿 11）。2026-08-17 全部 15 个项目完成进阶深化（每项目 +3~18 篇：领域进阶迭代 + ADR 决策资产 + 工业前沿校准）。2026-08-15 完成全量学习路线排序与进阶补充；2026-08-16 新增附录 17-Kafka（10 篇）、18-Observation（8 篇）、19-Agent沙箱（1 篇）、12-评估生态（+3 篇）、11/16/03 扩充各 1 篇、教程 48-多模态、49-支付、前沿 10-边缘Agent，并启动教程 48 篇全量修复+深化（见 PLAN.md）。
...
│   └── 18-企业级Agent数据与知识中枢/      # 知识视角（11 篇：Connector/语义层/治理/时效失效/检索服务/共享目录）
│
...
| [18-企业级Agent数据与知识中枢](项目/18-企业级Agent数据与知识中枢/00-需求分析与架构设计.md) | **知识视角旗舰** | 知识即资产：Connector/语义层口径唯一/质量血缘/时效失效链/检索服务/共享目录 | 11 |
