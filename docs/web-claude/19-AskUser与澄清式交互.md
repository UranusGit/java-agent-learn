...
>
> **Web 项目专项**：
> - 移动端审批 UI 全屏化：21 章 §7.5；
> - 跨 tab 同步（在 tab B 答，tab A 也要消失）：22 章 §4.5；
> - 离线时 question 排队：22 章 §2.5；
> - a11y（屏幕阅读器播报新 question）：21 章 §13；
> - 键盘快捷键（Tab 选答案、Enter 提交）：21 章 §8。
...
进入下一节：**20-审批与审核流**——复用 QuestionBus 实现工具审批 / Diff Review / 任务阶段确认。
