...
>
> **关联章节**：
> - 路由与 17 章活动流 / 19 章 AskUser / 20 章审批 强相关（多页面共享 session 状态）；
> - 跨标签页 / 实时协作见 22 章；
> - Web 安全（XSS / postMessage / CSP / 分享链接）见 23 章；
> - 前端错误监控见 23 章 §6；
...
进入下一节：**22-跨标签页与实时协作**——让多标签页 / 多人能同时观察同一 session，且状态一致。
