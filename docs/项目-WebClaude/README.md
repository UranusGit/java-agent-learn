...
```mermaid
flowchart LR
    P0["Phase 0<br/>调研与设计<br/>00 → 01"] --> P1["Phase 1<br/>MVP 骨架<br/>02 → 09<br/>v1.0 单租户"]
    P1 --> P2["Phase 2<br/>企业接入<br/>10 → 12<br/>v1.1 多租户 + 长程任务 + Hooks"]
    P2 --> P3["Phase 3<br/>机制深化<br/>13 → 20<br/>v1.2+ 完整工程范式"]
    P3 --> P4["Phase 4<br/>Web 工程化<br/>21 → 27<br/>v2.0 Web 项目专属 + 安全 + 生产部署"]
    P4 --> P5["Phase 5<br/>商业化 P0<br/>28 → 34<br/>v2.1 限流 / 计费 / 多租户 / 合规"]
```
...
```mermaid
flowchart TD
    c00["00 调研"] --> c01["01 设计"] --> c02["02 环境"] --> c03["03 骨架"] --> c04["04 Agent Loop"] --> c05["05 工具"] --> c06["06 沙箱"] --> c07["07 持久化"] --> c08["08 WS 重连"] --> c09["09 Artifacts"]
    c03 -.横切.-> c17["17 全链路可观测"]
    c10["10 集成 ai-serving"] --> c11["11 长程任务"] --> c12["12 Hooks"]
    c11 --> c13["13 Harness"]
    c12 --> c13
    c13 --> c14["14 上下文工程"] --> c18["18 错误恢复"]
    c14 --> c15["15 Subagent"] --> c16["16 MCP 协议"]
    c19["19 AskUser"] --> c20["20 审批流"]
    c21["21 前端工程化"] --> c22["22 跨标签页与协作"] --> c23["23 Web 安全与分享"] --> c24["24 智能体安全"] --> c25["25 记忆系统"]
    c26["26 测试与评估"] --> c27["27 生产部署深度"]
```
