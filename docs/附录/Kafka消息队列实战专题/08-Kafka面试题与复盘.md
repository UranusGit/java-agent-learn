# Kafka 面试题与复盘（读完 01-07 的自测清单）

> 前面 01-07 是"学会"，这一篇是"检验自己会不会"。它不是堆题，而是帮你把七篇的知识**串成一张网**——每题都标了「核心要点 → 一句进阶 → 回哪篇复习」。
>
> **怎么用**：先别翻答案，在心里或纸上答一遍，再对「核心」。答不上的题，按「复习」回对应章节。全部能脱口而出，说明你真正掌握了。
>
> 定位对应：01 概念 / 02 调优 / 03 事件驱动 / 04 生产级 / 05 动手实践 / 06 可靠性 / 07 Connect。
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 2 章
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 2.2 节 / [02 调优](./02-Kafka进阶实战.md) 进阶第 1.3 节
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 9.3 节 / [02 调优](./02-Kafka进阶实战.md) 进阶第 1.3 节
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 2.4 节 / [03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 5 章
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 1.6 节
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 1 章
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 4.2-4.3 节 / [02 调优](./02-Kafka进阶实战.md) 进阶第 2.1 节
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 5.2 节 / [02 调优](./02-Kafka进阶实战.md) 进阶第 2.2 节
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 8.3 节 / [05 实践](./05-全知识点实践项目.md) 阶段 10
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 8.1 节 / [05 实践](./05-全知识点实践项目.md) 阶段 11
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 5.3-5.4 节 / [03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 7 章
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 9.1 节 / [06 可靠性](./06-Kafka可靠性专题.md) 第 2 章
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 2.2-2.3 节 / [05 实践](./05-全知识点实践项目.md) 阶段 9
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 2.1、2.7 节 / [04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 A
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 1.3-1.6 节 / [03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 4.3 节
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 5.4-5.5 节 / [06 可靠性](./06-Kafka可靠性专题.md) 第 3.3 节
...
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C.5-C.7
...
flowchart TD
    ...
    P["分区数（硬上限）"] --> MIN{"min()"}
    CAND --> MIN
    MIN -->|"有效并发 = min(实例×并发, 分区数)"| EFF["有效并发<br/>例：3 分区 + 3 实例各并发1 → 3<br/>10 分区 + 3 实例各并发4 → 10（被封顶）"]
```

- 展开：三个场景实测并行度：分区 3 + 并发 10 = 最多 3；分区 3 + 3 实例各并发 1 = 3；分区 10 + 3 实例各并发 4 = 10（3×4 超了被分区封顶到 10）。
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C.2-C.3 / [02 调优](./02-Kafka进阶实战.md) 进阶第 2.2 节
...
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C.4
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 2.1 节
...
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C.6
...
- 复习：[03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 0 章 / [02 调优](./02-Kafka进阶实战.md) 进阶第 5 章
...
- 复习：[03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 6 章 / [02 调优](./02-Kafka进阶实战.md) 进阶第 5.6 节
...
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 A
...
- 复习：[03 事件驱动](./03-事件驱动微服务端到端实战.md) 第 4.3 节 / [04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 A.5
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 7 章
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 3.1、3.6 节
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 3.5 节
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 3.2、3.4 节
...
- 复习：[02 调优](./02-Kafka进阶实战.md) 进阶第 3 章 + 本专题配套 [Kafka-Streams 流处理专题](../Kafka-Streams流处理专题/)
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 2.7 节 / [04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 A
...
- 复习：[07 Connect](./07-KafkaConnect数据管道.md) 第 1 章（Source vs Sink）、第 6 章（幂等/死信/多 worker）
...
- 复习：[06 可靠性](./06-Kafka可靠性专题.md) 第 1.2-1.5 节
...
- 复习：[04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C / [05 实践](./05-全知识点实践项目.md) 阶段 10
...
- 复习：[01 概念](./01-Kafka消息队列从入门到架构师.md) 第 9.3 节 / [04 生产级](./04-生产级进阶-Outbox与Schema与分区调优.md) 方向 C.5
