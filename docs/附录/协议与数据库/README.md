...
> **关联**：SSE 对应 [35 号文档](../../tutorials/spring-ai-2.0/35-管数分离实战-从Sinks到Kafka演进.md) 全程的流式推送；事务对应第 7 章持久化的 `@Transactional` 幂等、以及 [事件驱动实战](../Spring-Cloud-Stream专题/03-事件驱动微服务端到端实战.md) 第 7.3 节的事务幂等。
