...
>
> 前置：[`./13-安全工程与红队.md`](./13-安全工程与红队.md) + [`./16-AI原生系统设计.md`](./16-AI原生系统设计.md)
> 预计：2-3 天
...
- 微调数据全人工审核
- 训练 / 推理用不同 prompt 模板
- 定期对模型做 red team（[`./13-安全工程与红队.md`](./13-安全工程与红队.md)）
...
详见 [`./11-评估闭环与Prompt版本管理.md`](./11-评估闭环与Prompt版本管理.md)。
...
- [`./13-安全工程与红队.md`](./13-安全工程与红队.md) —— Prompt Injection / 公平性
- [`./16-AI原生系统设计.md`](./16-AI原生系统设计.md) —— Event Sourcing + 审计
- [`./17-大规模Agent平台与数据基础设施.md`](./17-大规模Agent平台与数据基础设施.md) —— 多租户
- [`./15-多模型路由与国产化.md`](./15-多模型路由与国产化.md) —— 自托管 / 国产化
- [`./25-AI工程的SRE实践.md`](./25-AI工程的SRE实践.md) —— 监控 / Runbook
