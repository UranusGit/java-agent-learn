...
> 关于可观测性的完整方案，详见 [31-全链路可观测性](31-全链路可观测性.md)。
...
> **下一篇**：[21-微服务拆分与 Agent 部署](30-微服务拆分与Agent部署.md) — Agent 服务、工具服务、LLM 网关如何独立部署，服务间通信与 Spring Cloud 集成。
>
> **想深入**：[31-全链路可观测性](31-全链路可观测性.md) — 控制面可观测中心的数据来源和 Span 全链路追踪。
>
> **想深入**：[32-工具执行可观测与审计](32-工具执行可观测与审计.md) — 工具调用的安全审计需求与控制面策略引擎的关系。
