...
>
> **前置阅读**：[77-上下文工程](77-上下文工程.md)、[36-Agent 工作流编排](79-Agent工作流编排.md)。
...
**下一篇**：[82-高级记忆架构](82-高级记忆架构.md) — 三层记忆、语义 vs 情景记忆、记忆演化与衰减。

---

> **前置回顾**：[77-上下文工程](77-上下文工程.md)讲了 Token 预算分配——本章的 Token 效率优化是其延伸实践。
> **工作流**：并行工具调用在工作流编排中的应用，详见 [36-Agent 工作流编排](79-Agent工作流编排.md)。
> **评估**：优化效果需要量化评估，详见 [37-自我反思与 Agent 评估](80-自我反思与Agent评估.md)。
