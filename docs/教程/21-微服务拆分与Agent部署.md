...
>
> **读者画像**：已经理解管控分离架构（[20-管控分离架构](20-管控分离架构.md)），正在规划 Agent 系统的微服务部署方案，需要解决服务拆分粒度、通信协议选择、服务发现与治理等问题。
>
> **前置阅读**：[20-管控分离架构](20-管控分离架构.md)。
...
> **上一篇**：[20-管控分离架构](20-管控分离架构.md) — 控制面与数据面的架构分离，微服务拆分是数据面内部进一步的解耦。
>
