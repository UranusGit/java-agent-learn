...
>
> **前置阅读**：[02-ChatClient与对话模型](../00-基础与核心/02-ChatClient与对话模型.md)、[01-Spring-AI框架入门](../00-基础与核心/01-Spring-AI框架入门.md)。
...
**下一篇**：[86-Agent治理与合规框架](09-Agent治理与合规框架.md) — 企业级 Agent 上线前的完整治理清单。

---

> **想深入？→ [教程 08-架构师进阶/06-长任务持久化与中断恢复]**：流式中断后的检查点恢复。
> **想深入？→ [教程 08-架构师进阶/10-多模型协作与供应策略]**：降级时切换到哪个备选模型。
