...
>
> **前置阅读**：[04-记忆与会话管理](04-记忆与会话管理.md)、[58-历史记录持久化与合规](58-历史记录持久化与合规.md)。
...
**上一篇**：[58-历史记录持久化与合规](58-历史记录持久化与合规.md) — 数据生命周期管理为多租户隔离提供了归档和合规基础。

**下一篇**：[60-成本治理与Token计量](60-成本治理与Token计量.md) — 多租户场景下的 Token 配额需要精细化的成本计量体系。

**相关阅读**：
- [04-记忆与会话管理](04-记忆与会话管理.md) — ChatMemory 的基本概念，本篇在此基础上增加了租户隔离层。
- [61-Human-in-the-Loop与审批流](61-Human-in-the-Loop与审批流.md) — Level 3 危险工具的审批流程。
- [62-灰度发布与版本管理](62-灰度发布与版本管理.md) — 按租户灰度发布新 Prompt 和模型。
