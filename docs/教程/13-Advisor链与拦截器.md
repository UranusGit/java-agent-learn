...
> **想深入？→ [教程 16-全链路可观测性]**：如何将 Filter、Interceptor 和 Advisor 的可观测数据统一关联到一个 Trace 链路。
...
> **想深入？→ [教程 16-全链路可观测性]**：将 Advisor 与 Filter、Interceptor 的可观测数据统一到一条 Trace 链路。
> **想深入？→ [教程 11-Agent状态管理.md]**：Advisor 上下文在 Agent 状态管理中的关键作用。
