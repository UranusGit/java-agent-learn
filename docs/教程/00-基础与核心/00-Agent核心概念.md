...
> **遇到阻塞？→ [教程 00-基础与核心/01-Spring-AI框架入门]**：了解 Spring AI 2.0 的完整架构和项目搭建。
> **遇到阻塞？→ [教程 00-基础与核心/02-ChatClient与对话模型]**：深入 ChatClient API 和 Prompt 工程。
...
> **遇到阻塞？→ [教程 00-基础与核心/03-工具调用]**：深入 Function Calling、工具注册与发现、@Tool 注解全解。
...
> **遇到阻塞？→ [教程 00-基础与核心/04-记忆与会话管理]**：深入 ChatMemory API、短期 vs 长期记忆、会话隔离。
> **想深入？→ [教程 08-架构师进阶/05-高级记忆架构]**：三层记忆架构、语义记忆 vs 情景记忆、记忆演化与衰减。
...
> **遇到阻塞？→ [教程 00-基础与核心/07-ReAct推理模式]**：深入 Thought-Action-Observation 循环。
> **遇到阻塞？→ [教程 00-基础与核心/08-Plan-and-Execute模式]**：深入规划-执行分离架构。
...
> **遇到阻塞？→ [教程 04-企业级架构主干/10-容错与弹性设计]**：重试、降级、熔断、超时策略。
> **遇到阻塞？→ [教程 08-架构师进阶/03-自我反思与Agent评估]**：如何量化评估 Agent 效果。
...
> **遇到阻塞？→ [教程 04-企业级架构主干/07-成本治理与Token计量]**：Token 计量、预算控制、成本归因。
...
|-------|------|---------------|---------|
| L0 | 一问一答，无状态 | ChatClient | [教程 00-基础与核心/02-ChatClient与对话模型](02-ChatClient与对话模型.md) |
| L1 | 多轮对话，有记忆 | ChatMemory + MemoryAdvisor | [教程 00-基础与核心/04-记忆与会话管理](04-记忆与会话管理.md) |
| L2 | 能执行操作 | @Tool + ToolCallingAdvisor | [教程 00-基础与核心/03-工具调用](03-工具调用.md) |
| L3 | 有私有知识 | VectorStore + QuestionAnswerAdvisor | [教程 00-基础与核心/05-RAG检索增强生成](05-RAG检索增强生成.md) |
| L4 | 完整 Agent | 全部组件组合 | 项目实战 |
| L5 | 多 Agent 协作 | 多 ChatClient 编排 | [教程 00-基础与核心/09-多Agent协作](09-多Agent协作.md) |
