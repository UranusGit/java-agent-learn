...
>
> **前置阅读**：[36-Agent 工作流编排](79-Agent工作流编排.md)、[77-上下文工程](77-上下文工程.md)。
...
**下一篇**：[38-Agent 性能优化](81-Agent性能优化.md) — 批量推理、并行工具调用、流式 + 缓存、虚拟线程。

---

> **前置回顾**：[36-Agent 工作流编排](79-Agent工作流编排.md)讲了 IterativeRefinementWorkflow——本章的 Reflection 模式是其理论支撑。
> **RAG 评估**：检索召回率和答案忠实度的评估，详见 [35-高级 RAG 与 Agentic RAG](78-高级RAG与AgenticRAG.md) 第 7 节。
> **上下文影响**：Token 效率与上下文工程紧密相关，详见 [77-上下文工程](77-上下文工程.md)。
