...
>
> **前置阅读**：[35-长任务持久化与中断恢复](35-长任务持久化与中断恢复.md)、[36-数据飞轮与持续改进](36-数据飞轮与持续改进.md)。
...
**下一篇**：[39-多模型协作与供应策略](39-多模型协作与供应策略.md) — 模型编排、多供应商冗余、API Key 池管理。

---

> **想深入？→ [教程 36-数据飞轮与持续改进]**：治理框架中的持续监控与飞轮结合。
> **想深入？→ [教程 40-Agent架构反模式与避坑指南]**：「安全裸奔」反模式的完整分析。
