...
**下一篇**：[30-高级 RAG 与 Agentic RAG](78-高级RAG与AgenticRAG.md) — GraphRAG 多跳推理、Agentic RAG 自主决策检索、混合检索与重排。

---

> **前置回顾**：[04-记忆与会话管理](04-记忆与会话管理.md)介绍了 MessageWindowChatMemory 的滑动窗口——本章是它的"企业级进化版"。
> **想深入**：[82-高级记忆架构](82-高级记忆架构.md)将讲透三层记忆（短期→长期→外部 RAG）的完整架构，与本章的上下文工程紧密呼应。
> **性能优化**：[33-Agent 性能优化](81-Agent性能优化.md)会继续讨论 KV Cache 和批量推理对延迟的影响。
