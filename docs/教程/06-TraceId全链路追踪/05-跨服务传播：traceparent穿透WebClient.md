...
>
> **前置阅读**：[教程 00-基础与核心/01-Spring-AI框架入门 §1.3]（traceparent 报文）、[教程 00-基础与核心/03-工具调用]。
>
...
下一关 [教程 00-基础与核心/06-向量数据库选型]：**展示**——把 traceId 时间线用 SSE 推到前端页面，用户看得见"Agent 正在干什么 + 这一步的链路号"，报警体验闭环到 UI。
