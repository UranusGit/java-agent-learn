...
>
> **前置阅读**：[42-响应式错误处理](42-响应式错误处理.md)、[43-Agent治理与合规框架](43-Agent治理与合规框架.md)。
...
/** 数据脱敏（示意）——真实实现见教程 43 §4.3 DataSanitizer */
class DataSanitizer {
...
**下一篇**：[45-Agent架构反模式与避坑指南](45-Agent架构反模式与避坑指南.md) — 全量反模式汇总，整个教程体系的收官篇。

---

> **想深入？→ [教程 42-响应式错误处理]**：多模型故障切换的响应式实现。
> **想深入？→ [教程 43-Agent治理与合规框架]**：模型卡片和数据驻留的合规要求。
> **想深入？→ [教程 45-Agent架构反模式与避坑指南]**：「单模型无降级」反模式的完整分析。
