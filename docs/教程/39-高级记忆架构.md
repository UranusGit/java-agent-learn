...
>
> **前置阅读**：[04-记忆与会话管理](04-记忆与会话管理.md)、[34-上下文工程](34-上下文工程.md)、[05-RAG 检索增强生成](05-RAG检索增强生成.md)。
...
**进阶篇（34-39）小结**：
- [34-上下文工程](34-上下文工程.md) — 上下文窗口的 RAM 管理
- [35-高级 RAG 与 Agentic RAG](35-高级RAG与AgenticRAG.md) — 从塞文档到自主检索
- [36-Agent 工作流编排](36-Agent工作流编排.md) — DAG / 状态机 / 条件分支
- [37-自我反思与 Agent 评估](37-自我反思与Agent评估.md) — 自评迭代 + 质量度量
- [38-Agent 性能优化](38-Agent性能优化.md) — 延迟 / 成本 / 并发优化
- **39-高级记忆架构** — 三层记忆 + 演化 + 遗忘

**下一篇**：[40-长任务持久化与中断恢复](40-长任务持久化与中断恢复.md) — 进阶 II 篇开启：Checkpoint、断点恢复、预算控制。

---

> **前置回顾**：[04-记忆与会话管理](04-记忆与会话管理.md)介绍了 MessageWindowChatMemory——本章是它的"企业级终极进化版"。
> **上下文协同**：记忆的召回结果需要注入上下文窗口，拼接策略详见 [34-上下文工程](34-上下文工程.md)。
> **性能考量**：记忆检索的延迟优化（语义缓存 / 并行检索），详见 [38-Agent 性能优化](38-Agent性能优化.md)。
> **RAG 对比**：第 3 层外部检索与 [05-RAG 检索增强生成](05-RAG检索增强生成.md) 和 [35-高级 RAG](35-高级RAG与AgenticRAG.md) 的技术栈一致，区别在于记忆是"个人化的 RAG"。
