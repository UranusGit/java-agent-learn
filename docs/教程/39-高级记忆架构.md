...
public class ThreeTierMemoryService {
    ...
    public void persist(String userId, String conversationId) {
        List<Message> history = shortTermMemory.get(conversationId, 30);   // lastN 必带
...
- [30-高级 RAG 与 Agentic RAG](35-高级RAG与AgenticRAG.md) — 从塞文档到自主检索
- [31-Agent 工作流编排](36-Agent工作流编排.md) — DAG / 状态机 / 条件分支
- [32-自我反思与 Agent 评估](37-自我反思与Agent评估.md) — 自评迭代 + 质量度量
- [33-Agent 性能优化](38-Agent性能优化.md) — 延迟 / 成本 / 并发优化
...
> **性能考量**：记忆检索的延迟优化（语义缓存 / 并行检索），详见 [33-Agent 性能优化](38-Agent性能优化.md)。
> **RAG 对比**：第 3 层外部检索与 [05-RAG 检索增强生成](05-RAG检索增强生成.md) 和 [30-高级 RAG](35-高级RAG与AgenticRAG.md) 的技术栈一致，区别在于记忆是"个人化的 RAG"。
