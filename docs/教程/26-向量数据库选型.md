...
vectorStore.add(List.of(
    new Document("Java 21 虚拟线程",
        Map.of("category", "java", "version", "21")),
    new Document("Spring AI 框架",
        Map.of("category", "spring", "version", "2.0"))
));
...
**下一篇**：[27-模型路由与降级](27-模型路由与降级.md) — 多模型管理、路由策略、降级链设计。

---

> **想深入？→ [教程 30-高级RAG与AgenticRAG]**：不同向量库在 Agentic RAG 多跳推理场景下的表现差异。
> **遇到阻塞？→ [教程 24-容错与弹性设计](24-容错与弹性设计.md)**：向量数据库不可用时的降级策略。
