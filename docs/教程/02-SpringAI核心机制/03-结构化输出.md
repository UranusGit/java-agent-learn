...
**下一篇**：[23-Advisor链与拦截器](04-Advisor链与拦截器.md) — CallAdvisor/StreamAdvisor 双接口、链式执行与自定义拦截器。
...
> **遇到阻塞？→ [教程 02-SpringAI核心机制/04-Advisor链与拦截器]**：理解 Advisor 链如何在结构化输出的前后添加自定义处理逻辑。
