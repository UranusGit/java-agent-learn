...
**下一篇**：[59-多租户隔离与资源治理](59-多租户隔离与资源治理.md) — 多租户场景下的会话隔离、数据隔离、资源配额、工具权限分级。

**前置阅读**：
- [04-记忆与会话管理](04-记忆与会话管理.md) — ChatMemory 的基本概念，本篇在此基础上讨论持久化与合规。

**相关阅读**：
- [60-成本治理与Token计量](60-成本治理与Token计量.md) — 审计日志中的 Token 消耗数据如何用于成本治理。
- [61-Human-in-the-Loop与审批流](61-Human-in-the-Loop与审批流.md) — 危险操作的审计追踪。
