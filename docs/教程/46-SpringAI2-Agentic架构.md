...
> **定位**：本文回答一个全体系悬而未决的问题——**什么时候该用 Spring AI 2.0 原生的 agentic/编排能力，什么时候手写**。对照手写编排（教程 06/07/31）与框架原生抽象，给出选型决策框架。读者画像：读完编排相关章节、准备动手做架构选型的开发者。前置阅读：[教程 36-Agent工作流编排]、[教程 19-流式工具调用与事件协议]。
>
