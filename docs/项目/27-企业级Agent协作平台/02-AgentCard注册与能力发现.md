...
> **定位**：把 01 的内存注册表工程化为**注册中心**：**① AgentCard 声明式注册/版本化 ② 心跳与健康（下线 Agent 不再被发现）③ 能力发现的匹配语义（精确/语义两级）**。呼应 [03-MCP网关注册中心](../../项目/03-MCP工具网关/00-需求分析与架构设计.md)、[教程 54 §2](../../教程/97-Agent间协作协议工程化.md)。前置阅读：[01-最小Demo](01-最小Demo.md)。
>
