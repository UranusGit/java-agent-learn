...
| ② 主体迭代 | 02-迭代一-工具集成、03-迭代二-RAG知识库、04-迭代三-记忆与会话、05-核心代码讲解 | **严格顺序**：工具 → RAG → 记忆逐层叠加，每篇过验收再前进；05 是主体迭代的代码地图与设计复盘 |
...
| 迭代一 | 工具集成 | [02-迭代一-工具集成](02-迭代一-工具集成.md) | FAQ、订单查询 |
| 迭代二 | RAG 知识库 | [03-迭代二-RAG 知识库](03-迭代二-RAG知识库.md) | 向量检索问答 |
| 迭代三 | 记忆与会话 | [04-迭代三-记忆与会话](04-迭代三-记忆与会话.md) | 多轮对话、Redis 持久化 |
