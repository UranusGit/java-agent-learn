...
| 2 | `PromptGrayRouterTest` | hash 分流确定性；边界 0% 与 100% 行为正确 |
...
| 2 | `mvn clean test` | 全部测试类（GoldenRegression/FeedbackAttributor/PromptGrayRouter/SatisfactionEvaluator）通过 |
