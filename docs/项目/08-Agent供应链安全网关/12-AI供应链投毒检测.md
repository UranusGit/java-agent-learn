...
>
> 「遇到阻塞？→ [附录 08-Agent安全深度/01-ToolPoisoning攻击]、[附录 12-AI治理与合规/01-模型卡片与数据卡片]、[教程 04-企业级架构主干/11-安全与权限控制 §注入防御]、[前沿 04-MCP生态全景 §供应链安全]」
>
...
| 评估指标 | "MMLU 78.2" | 网关侧复测（评估集来自 [教程 08-架构师进阶/03-自我反思与Agent评估] 的金标思路） | 偏差 > 阈值降级使用范围 |
