...
>
> 「遇到阻塞？→ [教程 04-企业级架构主干/01-微服务拆分与Agent部署 §模块化单体]、[教程 00-基础与核心/01-Spring-AI框架入门]、[教程 00-基础与核心/02-ChatClient与对话模型]、[教程 00-基础与核心/03-工具调用]；API 真实性以 [附录 05-SpringAI2-API基准] 为准」
