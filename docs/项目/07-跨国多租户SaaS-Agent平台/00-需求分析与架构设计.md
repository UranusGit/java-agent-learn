...
>
> 「遇到阻塞？→ [教程 20-多租户隔离与资源治理 全篇]、[教程 23-灰度发布与版本管理]、[教程 28-部署与运维 §多区域]、[教程 21-成本治理与Token计量]」
>
> **API 真实性**：本项目的全部代码以 [附录 12-SpringAI2-API基准] 为准——`ChatClient`/`@Tool`/`CallAdvisor`/`ChatMemory` 均为 Spring AI 2.0.0 真实签名，可照抄编译。
