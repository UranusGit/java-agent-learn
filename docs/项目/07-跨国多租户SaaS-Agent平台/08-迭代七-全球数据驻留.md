...
>
> 「遇到阻塞？→ [教程 28-部署与运维 §多区域]、[附录 09-AI治理与合规/02-数据隐私与偏见检测 §跨境传输]、[教程 38-Agent治理与合规框架]；API 真实性以 [附录 12-SpringAI2-API基准] 为准」
...
EU 区签约的 Enterprise 客户进入安全审查阶段：要求提供 SOC 2 Type II 报告与渗透测试结果——平台从未做过系统性的安全审计建设。→ [09-迭代八-平台安全与SOC2.md](09-迭代八-平台安全与SOC2.md)
