...
> **定位**：长任务的**经济运营台 + 人工控制台**。核心：**① 预算实时可视化（每任务/每业务线 Token 成本看板）② 超限/异常的 HITL 暂停/恢复 ③ 预算调整与告警**。呼应 [04-预算闸门](04-三层预算与死循环防护.md)、[20-预算预测](../../项目/20-企业级Agent经济与结算平台/08-预算预测与成本治理.md)、[28-HITL](../../教程/61-Human-in-the-Loop与审批流.md)。前置阅读：[09-多机分布式续跑](09-多机分布式续跑.md)。
>
...
- **业务线聚合**：所有长任务的成本排行，谁是"烧钱大户"（呼应 [41-数据飞轮](../../教程/84-数据飞轮与持续改进.md) 的成本治理视角）。
...
- HITL 裁决记录进审计（07 取消审计延续 / 呼应 [28-HITL 审批流](../../教程/61-Human-in-the-Loop与审批流.md)）。
