...
- [ ] 完整审计实现以 02 篇 §6.3 为准（本节为讲解摘录），参数签名一致（8 参 record）
...
- [ ] ADR 03-08 引用的三类并发容器在 §3 代码中逐一出现
- [ ] ADR 03-09 的基准引用（附录 05-01/05-02）与本篇各验证小节的失败排查引用一致
