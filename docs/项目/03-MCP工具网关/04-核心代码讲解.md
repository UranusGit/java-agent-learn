...
>
> **前置阅读**：[01-最小 Demo 搭建](01-最小Demo搭建.md)、[02-迭代一-MCP 客户端集成](02-迭代一-MCP客户端集成.md)、[03-迭代二-自定义 MCP 服务端](03-迭代二-自定义MCP服务端.md)。API 真实性以 [附录 12-SpringAI2-API基准](../../附录/12-SpringAI2-API基准/01-MCP真实API与坐标.md) 为准。
