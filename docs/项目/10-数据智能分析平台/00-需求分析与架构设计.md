...
>
> 「遇到阻塞？→ [教程 02-SpringAI核心机制/04-结构化输出]、[教程 08-架构师进阶/01-高级RAG与AgenticRAG]、[教程 04-企业级架构主干/06-多租户隔离与资源治理 §数据权限]、[教程 04-企业级架构主干/11-安全与权限控制 §SQL 注入]、[教程 04-企业级架构主干/07-成本治理与Token计量]；API 真实性以 [附录 05-SpringAI2-API基准] 为准」
...
| 迭代 | 落地的教程知识 |
|------|---------------|
| 01 Text2SQL | [教程 02-SpringAI核心机制/04-结构化输出 §entity]、[教程 00-基础与核心/05-RAG检索增强生成 §2] |
| 02 SQL 护栏 | [教程 04-企业级架构主干/11-安全与权限控制 §SQL 注入]、[教程 04-企业级架构主干/06-多租户隔离与资源治理 §RLS] |
| 03 语义层 | [教程 08-架构师进阶/01-高级RAG与AgenticRAG §Agentic 检索]、[教程 02-SpringAI核心机制/04-结构化输出 §entity] |
...
| 06 报表 | [教程 02-SpringAI核心机制/04-结构化输出]、[附录 13-Agent交互设计] |
