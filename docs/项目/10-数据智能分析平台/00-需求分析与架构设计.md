...
| 迭代 | 落地的教程知识 |
|------|---------------|
| 01 Text2SQL | [教程 13-结构化输出 §entity]、[教程 05-RAG §Schema] |
...
| 06 报表 | [教程 12 §结构化输出]、[附录 14-Agent交互设计] |
| 07 成本 | [教程 27-成本治理与Token计量]、[附录 10-语义缓存与性能] |
| 08 数据质量 | [教程 37-自我反思与Agent评估]、[教程 36-数据飞轮] |
| 09 灰度多租户 | [教程 29-灰度发布与版本管理]、[教程 20 §多租户] |
