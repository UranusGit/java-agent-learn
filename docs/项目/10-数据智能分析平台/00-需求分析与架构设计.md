...
| 10 语义层深化 | [教程 35-高级RAG与AgenticRAG]、[教程 29-灰度发布与版本管理 §版本门禁]、[教程 05-RAG检索增强生成 §2] |
| 11 评测护栏升级 | [教程 37-自我反思与Agent评估]、[教程 41-数据飞轮与持续改进]、[附录 04-测试策略/02-Eval评估] |
| 12 血缘治理 | [教程 28-Human-in-the-Loop与审批流 §审批触发]、[教程 25-历史记录持久化与合规]、[附录 07-企业级架构模式] |
