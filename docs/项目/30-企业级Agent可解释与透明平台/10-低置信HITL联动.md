...
> **定位**：让置信度**触发行为**而非停留在数字——**① 置信×风险 路由矩阵（自动放行/复核/拦截）② 复核工作台（解释即审核材料）③ 复核结果回流（校准+规则改进）**。呼应 [28-HITL](../../教程/61-Human-in-the-Loop与审批流.md)、[06-置信度分级](../../项目/06-金融风控Agent系统/02-置信度与风险分级.md)、[24-预算HITL](../../项目/24-企业级长任务工作流引擎/10-预算可视化与HITL暂停恢复.md)。前置阅读：[09-解释质量评估与飞轮](09-解释质量评估与飞轮.md)。
>
