...
> **关联教程**：[教程 03-工具调用](../../教程/03-工具调用.md)、[教程 21-Agent状态管理](../../教程/21-Agent状态管理.md)。
...
> 「遇到阻塞？→ [教程 21-Agent状态管理](../../教程/21-Agent状态管理.md)」
...
> 「遇到阻塞？→ [教程 77-上下文工程](../../教程/77-上下文工程.md)」
...
> 「遇到阻塞？→ [教程 32-工具执行可观测与审计](../../教程/32-工具执行可观测与审计.md)」
