...
>
> 「遇到阻塞？→ [教程 87-多模型协作与供应策略 §边缘部署]、[前沿 02-多模态Agent]、[教程 63-容错与弹性设计]、[教程 83-长任务持久化与中断恢复]」
...
| 迭代 | 落地的教程知识 |
|------|---------------|
| 01 时序异常 | [教程 63-容错与弹性设计 §异常检测]、[教程 10-WebFlux从零入门] |
| 02 视觉质检 | [前沿 02-多模态Agent]、[教程 03-工具调用] |
| 03 预测性维护 | [教程 82-高级记忆架构 §时序记忆]、[教程 05-RAG] |
| 04 边缘部署 | [教程 87-多模型协作与供应策略 §边缘部署] |
| 05 工单自动化 | [教程 61-Human-in-the-Loop与审批流]、[附录 05-SpringAI2-API基准/02 §1.3] |
| 06 工艺优化 | [教程 08-Plan-and-Execute模式]、[教程 80-自我反思与Agent评估] |
| 07 多产线隔离 | [教程 59-多租户隔离与资源治理]、[教程 85-响应式错误处理 §Context 传递] |
| 08 高可用断网 | [教程 63-容错与弹性设计]、[教程 66-部署与运维 §演练] |
| 09 边缘推理优化（v9，[10](10-边缘AI推理优化.md)） | [教程 81-Agent性能优化 §批量请求合并]、[教程 65-模型路由与降级]、[教程 83-长任务持久化与中断恢复 §幂等]、[附录 15-AIInfra与推理部署] |
| 10 多模态融合（v10，[11](11-多模态融合质检.md)） | [教程 91-多模态Agent开发 §2 消息构造、§6 成本模型]、[教程 61-Human-in-the-Loop与审批流 §风险分级] |
| 11 模型管理（v11，[12](12-预测性维护模型管理.md)） | [教程 84-数据飞轮与持续改进 §5、§7]、[教程 62-灰度发布与版本管理 §流量切分]、[附录 12-AI治理与合规/01-模型卡片与数据卡片] |
