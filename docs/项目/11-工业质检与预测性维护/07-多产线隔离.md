...
curl -H "X-Line-Id: line-a" "http://localhost:8080/api/pdm/explain/pump-01"   # 注塑线 pump-01
curl -H "X-Line-Id: line-a" "http://localhost:8080/api/inspection/confirm?imageId=x&modelLabel=气孔&correct=false"  # 写装配线难例
```
