...
>
> 「遇到阻塞？→ [教程 80-自我反思与Agent评估 全篇]、[附录 04-测试策略/02-Eval评估]、[教程 84-数据飞轮与持续改进]；API 真实性以 [附录 05-SpringAI2-API基准] 为准」
...
public class OnlineMetrics {
    ...
    /** 误报率 = dismissed / total（comment_id 全链路透传，响应式上下文传递见 [教程 85-响应式错误处理]）。 */
