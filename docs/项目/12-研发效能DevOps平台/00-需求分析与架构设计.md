...
> **定位**：某中大型软件企业的研发效能 Agent 平台——代码库问答、代码审查、测试生成、CI/CD 诊断、多 Agent 评审流水线、评估闭环与私有代码安全。项目 12 是**完整独立**的项目，不依赖也不引用其他项目。**本项目的核心使命：把教程 00-基础与核心/03-工具调用（工具）、09（多Agent）、36（工作流）、37（评估）、38（性能）、31（私有代码安全）在"研发流程智能化"场景落地。**
>
> 「遇到阻塞？→ [教程 00-基础与核心/03-工具调用]、[教程 00-基础与核心/09-多Agent协作]、[教程 08-架构师进阶/02-Agent工作流编排]、[教程 08-架构师进阶/03-自我反思与Agent评估]、[教程 04-企业级架构主干/11-安全与权限控制 §私有代码]」
...
| 迭代 | 落地的教程知识 |
|------|---------------|
| 01 代码问答 | [教程 00-基础与核心/05-RAG检索增强生成]、[附录 01-LLM基础理论/01-Embedding原理] |
| 02 代码审查 | [教程 04-企业级架构主干/11-安全与权限控制 §SAST]、[教程 08-架构师进阶/03-自我反思与Agent评估 §误报] |
| 03 测试生成 | [教程 00-基础与核心/04-记忆与会话管理]、[教程 08-架构师进阶/03-自我反思与Agent评估 §质量闸门] |
| 04 CI 诊断 | [教程 04-企业级架构主干/02-全链路可观测性 §日志]、[教程 04-企业级架构主干/10-容错与弹性设计 §重试] |
| 05 多 Agent 评审 | [教程 00-基础与核心/09-多Agent协作]、[教程 08-架构师进阶/02-Agent工作流编排] |
| 06 工作流编排 | [教程 08-架构师进阶/02-Agent工作流编排 全篇]、[教程 02-SpringAI核心机制/02-Agent状态管理] |
| 07 评估闭环 | [教程 08-架构师进阶/03-自我反思与Agent评估 全篇]、[附录 04-测试策略/02-Eval评估] |
| 08 私有代码安全 | [教程 04-企业级架构主干/11-安全与权限控制 §数据不出域]、[附录 08-Agent安全深度] |
| 09 仓库知识图谱（v9，[10](10-代码理解与仓库知识图谱.md)） | [教程 08-架构师进阶/01-高级RAG与AgenticRAG §GraphRAG]、[附录 10-知识图谱工程] |
| 10 评审深化（v10，[11](11-多Agent评审深化.md)） | [教程 00-基础与核心/09-多Agent协作 §协作模式]、[教程 08-架构师进阶/03-自我反思与Agent评估 §评估指标体系] |
| 11 CI 自愈（v11，[12](12-CICD自愈与瓶颈优化.md)） | [教程 04-企业级架构主干/08-Human-in-the-Loop与审批流 §风险分级]、[教程 04-企业级架构主干/10-容错与弹性设计 §熔断] |
