...
>
> 「遇到阻塞？→ [教程 03-工具调用]、[教程 09-多Agent协作]、[教程 79-Agent工作流编排]、[教程 80-自我反思与Agent评估]、[教程 64-安全与权限控制 §私有代码]」
...
| 02 代码审查 | [教程 64-安全与权限控制 §SAST]、[教程 80-自我反思与Agent评估 §误报] |
| 03 测试生成 | [教程 04-记忆与会话管理]、[教程 80-自我反思与Agent评估 §质量闸门] |
| 04 CI 诊断 | [教程 31-全链路可观测性 §日志]、[教程 63-容错与弹性设计 §重试] |
| 05 多 Agent 评审 | [教程 09-多Agent协作]、[教程 79-Agent工作流编排] |
| 06 工作流编排 | [教程 79-Agent工作流编排 全篇]、[教程 21-Agent状态管理] |
| 07 评估闭环 | [教程 80-自我反思与Agent评估 全篇]、[附录 04-测试策略/02-Eval评估] |
| 08 私有代码安全 | [教程 64-安全与权限控制 §数据不出域]、[附录 08-Agent安全深度] |
| 09 仓库知识图谱（v9，[10](10-代码理解与仓库知识图谱.md)） | [教程 78-高级RAG与AgenticRAG §GraphRAG]、[附录 10-知识图谱工程] |
| 10 评审深化（v10，[11](11-多Agent评审深化.md)） | [教程 09-多Agent协作 §协作模式]、[教程 80-自我反思与Agent评估 §评估指标体系] |
| 11 CI 自愈（v11，[12](12-CICD自愈与瓶颈优化.md)） | [教程 61-Human-in-the-Loop与审批流 §风险分级]、[教程 63-容错与弹性设计 §熔断] |
