...
>
> **前置阅读**：[06-长文档理解与上下文工程](06-长文档理解与上下文工程.md)、[教程 06-TraceId全链路追踪/02-Tracer编程模型：手动开span Agent 开发](../../教程/09-前沿专题/02-多模态Agent开发.md)、[教程 02-SpringAI核心机制/04-结构化输出](../../教程/02-SpringAI核心机制/04-结构化输出.md)。API 真实性以 [附录 05-SpringAI2-API基准](../../附录/05-SpringAI2-API基准/00-Advisor与ChatMemory.md) 为准。
>
