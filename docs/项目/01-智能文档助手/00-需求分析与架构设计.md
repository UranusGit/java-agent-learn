...
| 02 | [迭代一-文档解析与向量化](02-迭代一-文档解析与向量化.md) | 阶段一：基础构建 | Tika 多格式解析、段落感知分块、异步 ETL、批量向量化 |
| 03 | [迭代二-多源检索与重排](03-迭代二-多源检索与重排.md) | 阶段一：基础构建 | 混合检索双路召回 + Cross-Encoder 重排 + LLM 原生引用 |
