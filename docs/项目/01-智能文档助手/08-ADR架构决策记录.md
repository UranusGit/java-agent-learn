...
>
> **前置阅读**：[00-需求分析与架构设计](00-需求分析与架构设计.md) 至 [07-文档多模态理解](07-文档多模态理解.md)。方法论依据 [附录 08-架构决策方法论/00-ADR架构决策记录](../../附录/08-架构决策方法论/00-ADR架构决策记录.md)。
>
...
**ADR 四要素**（[附录 08-架构决策方法论/00-ADR架构决策记录](../../附录/08-架构决策方法论/00-ADR架构决策记录.md)）：上下文（当时的问题与约束）、决策（选了哪个）、后果（代价是什么）、可回滚性（怎么退）。本文统一再加一列**备选方案**——没有备选的决策不是决策，是默认。
