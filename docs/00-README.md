...
│
├── 教程/                         # 🛠️ 主线教程（代码导向，对照手搓）
│   ├── langchain4j/              # 阶段 1 入门（9 篇，理解 LLM 调用本质）
│   ├── spring-ai-2.0/            # ⭐ 主线核心（39 篇，最终交付栈）
│   └── agent/                    # Agent 进阶（7 篇）
│
...
```mermaid
flowchart LR
    P["计划/00-整体路线<br/>先看全局"] --> L1["教程/langchain4j<br/>阶段1 入门"]
    L1 --> L2["教程/spring-ai-2.0<br/>⭐ 主线核心（最终栈）"]
    L2 --> A["教程/agent<br/>Agent 进阶"]
...
2. 从"阶段 0：环境准备"开始
3. 进入阶段 1 时，对照 `教程/langchain4j/01-快速起步.md` 手搓代码
