...
│   └── progress.md               # 进度追踪
│
├── 教程/                         # 🛠️ 主线教程（扁平，代码导向，对照手搓）
│   ├── 入门-LangChain4j-01~09    # 阶段 1 入门（9 篇，理解 LLM 调用本质）
│   ├── 主线-SpringAI2.0-00~35    # ⭐ 主线核心（39 篇，最终交付栈）
│   └── 进阶-Agent-00~06          # Agent 进阶（7 篇）
│
...
```mermaid
flowchart LR
    P["计划/00-整体路线<br/>先看全局"] --> L1["教程/入门-LangChain4j-01<br/>阶段1 入门"]
    L1 --> L2["教程/主线-SpringAI2.0-00<br/>⭐ 主线核心（最终栈）"]
    L2 --> A["教程/进阶-Agent-00<br/>Agent 进阶"]
    L2 -.按需查阅.-> T["理论/<br/>概念字典 01-16"]
    L1 -.卡壳时.-> F["附录/<br/>补底层背景"]
    A -.实战参考.-> PJ["项目-WebClaude / 项目-AIServing<br/>真实系统拆解"]
```
...
2. 从"阶段 0：环境准备"开始
3. 进入阶段 1 时，对照 `教程/入门-LangChain4j-01-快速起步.md` 手搓代码
