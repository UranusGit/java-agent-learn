...
│   └── … 38-管数分离实战.md      # 共 39 篇（原 LC4j/Agent 系列已融合进对应章节）
│
...
├── 项目-客服Agent平台/           # 🏗️ 实战项目：企业级客服 Agent 平台（企业级演进路线，从阶段 0 开始）
│
...
flowchart LR
    ...
    L2 -.实战参考.-> PJ["项目-WebClaude / 项目-AIServing / 项目-客服Agent平台<br/>真实系统拆解"]
```
...
| **项目-*** | 真实系统设计文档 | 做综合项目时参考（做客服/企业级综合项目 → **项目-客服Agent平台**：企业级演进路线，从阶段 0 开始） |
