...
| 方向 | 文档 | 内容 |
|------|------|------|
| 工具体系 | [阶段2-01-工具体系设计](../阶段2-核心能力/01-工具体系设计.md) | 多工具/错误处理/安全 |
| MCP 协议 | [阶段3-05-MCP协议入门](../阶段3-Agent工程化/05-MCP协议入门.md) | 跨框架工具接入 |
| Agent 循环 | [阶段3-01-Agent循环](../阶段3-Agent工程化/01-Agent循环.md) | decide-act-observe |
| 工具安全 | [阶段4-27-安全防护深入](../阶段4-生产化/27-Agent安全防护深入.md) | 工具权限隔离 |
| MCP Hub | [阶段6-04-MCPHub](../阶段6-前沿/04-MCPHub与工具市场.md) | 企业级工具市场 |
| 工具理论 | [理论字典-MCP协议](../理论字典/MCP协议.md) | MCP 核心概念速查 |
