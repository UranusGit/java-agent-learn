...
本篇是 Agent 安全审计的入门。安全是贯穿所有阶段的主题，以下是完整路线：

```mermaid
flowchart LR
    S3["阶段3<br/>Prompt注入防御"] --> S4A["阶段4<br/>安全审计"]
    S4A --> S4B["阶段4<br/>安全防护深入"]
    S4B --> S4C["阶段4<br/>红队对抗测试"]
    S4C --> S4D["阶段4<br/>供应链安全"]
    S4D --> S4E["阶段4<br/>密钥管理"]
    S4E --> S5A["阶段5<br/>PII脱敏管线"]
    S5A --> S6A["阶段6<br/>安全攻防前沿"]
    S6A --> Proj["项目11<br/>SentinelGuard"]
```

| 深度 | 文档 | 内容 |
|------|------|------|
| 入门 | [阶段3-04-PromptInjection防御](../阶段3-Agent工程化/04-PromptInjection防御.md) | 4 层防御体系 |
| 深入 | [27-Agent安全防护深入](27-Agent安全防护深入.md) | 6 大威胁防护方案 |
| 红队 | [31-Agent红队对抗测试](31-Agent红队对抗测试.md) | OWASP LLM Top 10 对抗 |
| 供应链 | [32-Agent供应链安全](32-Agent供应链安全.md) | MCP 工具与模型来源 |
| 密钥 | [33-Agent密钥与凭证管理](33-Agent密钥与凭证管理.md) | Vault / 零信任 |
| 隐私 | [阶段5-12-PII脱敏](../阶段5-架构师/12-AgentPII脱敏与数据隐私管线.md) | DLP 管线 |
| 前沿 | [阶段6-11-安全攻防前沿](../阶段6-前沿/11-Agent安全攻防前沿.md) | 2026 最新攻防 |
| 实战 | [项目11-SentinelGuard](../项目实践/11-企业项目-AI安全防御平台/00-总览.md) | 安全防御平台 |
| 速查 | [理论字典-Agent安全](../理论字典/Agent安全.md) | OWASP 速查表 |
