...
| 方向 | 文档 | 内容 |
|------|------|------|
| SLO 管理 | [36-SLO管理](36-AgentSLO管理.md) | 发布后 SLO 验证 |
| 事故响应 | [38-Agent事故响应与变更管理](38-Agent事故响应与变更管理.md) | 发布事故处理 |
| 版本兼容 | [23-Agent版本兼容性管理](23-Agent版本兼容性管理.md) | 平滑升级 |
| 配置灰度 | [09-Agent配置中心](09-Agent配置中心.md) | 灰度发布机制 |
| 评估实战 | [项目01-EvalGuard Sprint3](../项目实践/01-企业项目-Eval质量保障平台/Sprint3-流量回放.md) | 流量回放完整实战 |
