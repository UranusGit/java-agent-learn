...
> 上一级 → `进阶-Agent-01-Tool设计原则.md`（第 3 级）→ `02-Tool与AgentLoop.md`（第 2 级）→ `入门-LangChain4j-03-Tool调用.md`（第 1 级）。
...
完成后进入下一节：**04-实战项目-个人助理**——把 Tool 设计、防失控、多 Tool 编排整合成一个完整可演示的项目。
